...
#define VRING_RX_ADDRESS	(CONFIG_OPENAMP_IPC_SHM_BASE_ADDRESS + (CONFIG_OPENAMP_IPC_SHM_SIZE - 0x400) - 0x400)
#define VRING_TX_ADDRESS	(CONFIG_OPENAMP_IPC_SHM_BASE_ADDRESS + (CONFIG_OPENAMP_IPC_SHM_SIZE - 0x400))
